...
<div class = "login">
    <div class = "login_box">
        ...
        <div class = "login_box_title">
            <?php echo getLanguage("findPasswordPage_title"); ?>
        </div>
        <div class = "login_box_input" style = "margin-bottom: 50px;">
            <div id = "find_password_step1_<?php echo $menuNumber; ?>" style = "display: block;">
                <div class = "login_box_input_item">
                    <div class = "login_box_input_item_title">
                        <?php echo getLanguage("loginPage_input_email"); ?>
                    </div>
                    <input placeholder = "<?php echo getLanguage("loginPage_input_email"); ?>" id = "find_password_input_<?php echo $menuNumber ?>_email" type = "email" onkeydown = "checkFindPasswordInput(<?php echo $menuNumber ?>); if (event.keyCode == 13) { findPassword(<?php echo $menuNumber ?>); }">
                    <div class = "login_box_input_item_notice" id = "find_password_input_notice_<?php echo $menuNumber ?>_email"></div>
                </div>
            </div>
            <div id = "find_password_step2_<?php echo $menuNumber; ?>" style = "display: none;">
                <div class = "login_box_input_item">
                    <div class = "login_box_input_item_title">
                        <?php echo getLanguage("loginPage_input_verification_code"); ?>
                    </div>
                    <input placeholder = "<?php echo getLanguage("loginPage_input_verification_code"); ?>" id = "find_password_input_<?php echo $menuNumber ?>_auth_code" type = "text" onkeydown = "checkFindPasswordInput(<?php echo $menuNumber ?>); if (event.keyCode == 13) { findPassword(<?php echo $menuNumber ?>); }">
                    <div class = "login_box_input_item_notice" id = "find_password_input_notice_<?php echo $menuNumber ?>_auth_code"></div>
                </div>
            </div>
            <div id = "find_password_step3_<?php echo $menuNumber; ?>" style = "display: none;">
                <div class = "signup_password">
                    <div class = "login_box_input_item" style = "width: 50%;">
                        <div class = "login_box_input_item_title">
                            <?php echo getLanguage("loginPage_input_new_password"); ?>
                        </div>
                        <input placeholder = "<?php echo getLanguage("loginPage_input_new_password"); ?>" id = "find_password_input_<?php echo $menuNumber ?>_password" type = "password" onkeydown = "checkFindPasswordInput(<?php echo $menuNumber ?>); if (event.keyCode == 13) { findPassword(<?php echo $menuNumber ?>); }">
                        <div class = "login_box_input_item_notice" id = "find_password_input_notice_<?php echo $menuNumber ?>_password"></div>
                    </div>
                    <div class = "login_box_input_item" style = "width: 50%; margin-left: 20px;">
                        <div class = "login_box_input_item_title">
                            <?php echo getLanguage("loginPage_input_password2"); ?>
                        </div>
                        <input placeholder = "<?php echo getLanguage("loginPage_input_password2"); ?>" id = "find_password_input_<?php echo $menuNumber ?>_password2" type = "password" onkeydown = "checkFindPasswordInput(<?php echo $menuNumber ?>); if (event.keyCode == 13) { findPassword(<?php echo $menuNumber ?>); }">
                        <div class = "login_box_input_item_notice" id = "find_password_input_notice_<?php echo $menuNumber ?>_password2"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class = "login_box_bottom">
            ...
            <div class = "login_box_bottom_right">
                <div onclick = "findPassword(<?php echo $menuNumber ?>);" id = "login_box_bottom_right_confirm_<?php echo $menuNumber ?>_find_password" class = "login_box_bottom_right_confirm md-ripples">
