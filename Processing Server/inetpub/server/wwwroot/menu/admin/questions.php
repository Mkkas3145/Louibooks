...
<div class = "questions_info" style = "display: none;">
    <?php include_once('./php/questions/getInfoNumbers.php'); ?>
</div>

<div class = "menu_admin_questions">
    <div class = "menu_admin_questions_title">
        ...
    </div>
    <div class = "menu_admin_questions_sort">
        <div class = "sort_box md-ripples" onclick = "selectList(this, getMenuAdminQuestionsSortItems());" onchange = "menuAdminQuestionsOptionLoad(<?php echo $menuNumber; ?>);" popupwidth = "max-content" value = "1">
        ...
        <div class = "sort_box md-ripples" onclick = "selectList(this, getMenuAdminQuestionsTypeItems());" onchange = "menuAdminQuestionsOptionLoad(<?php echo $menuNumber; ?>);" popupwidth = "max-content" value = "0">
            <div class = "sort_box_title value_title">...</div>
            <div class = "sort_box_icon">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M17.418 6.109c0.272-0.268 0.709-0.268 0.979 0s0.271 0.701 0 0.969l-7.908 7.83c-0.27 0.268-0.707 0.268-0.979 0l-7.908-7.83c-0.27-0.268-0.27-0.701 0-0.969s0.709-0.268 0.979 0l7.419 7.141 7.418-7.141z"></path></svg>
            </div>
        </div>
        <div class = "sort_box md-ripples" onclick = "selectList(this, getLanguageSelectItem(true));" onchange = "menuAdminQuestionsOptionLoad(<?php echo $menuNumber; ?>);" popupwidth = "max-content" value = "all">
            <div class = "sort_box_title value_title">...</div>
            <div class = "sort_box_icon">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M17.418 6.109c0.272-0.268 0.709-0.268 0.979 0s0.271 0.701 0 0.969l-7.908 7.83c-0.27 0.268-0.707 0.268-0.979 0l-7.908-7.83c-0.27-0.268-0.27-0.701 0-0.969s0.709-0.268 0.979 0l7.419 7.141 7.418-7.141z"></path></svg>
            </div>
    ...
    <div class = "menu_admin_questions_items">
        <!-- item -->
    </div>
    <div class = "menu_admin_questions_no_data" style = "display: none;">
        ...
        <div class = "menu_admin_questions_no_data_title">
            ...
        </div>
        <div class = "menu_admin_questions_no_data_description">
            ...
        </div>
    </div>
</div>
<div class = "admin_questions_contents_loading" style = "padding: 20px; display: none;">
