<?php
    ...
    //
    $stmt = $pdo->prepare("SELECT number FROM works WHERE user_number = :user_number AND public_status = 0");
    $stmt->execute(array(
...
<div class = "user_navigation_works_sort">
    <div class = "sort_box md-ripples" onchange = "userNavigationWorksOptionLoad(<?php echo $menuNumber; ?>);" popupwidth = "max-content" value = "0" onclick = "selectList(this, getUserNavigationWorksSortItems());">
    ...
    <div class = "sort_box md-ripples" onchange = "userNavigationWorksOptionLoad(<?php echo $menuNumber; ?>);" popupwidth = "max-content" value = "0" onclick = "selectList(this, getUserNavigationWorksWorkTypeItems());">
        <div class = "sort_box_title value_title">...</div>
        <div class = "sort_box_icon">
            <!-- Generated by IcoMoon.io -->
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M17.418 6.109c0.272-0.268 0.709-0.268 0.979 0s0.271 0.701 0 0.969l-7.908 7.83c-0.27 0.268-0.707 0.268-0.979 0l-7.908-7.83c-0.27-0.268-0.27-0.701 0-0.969s0.709-0.268 0.979 0l7.419 7.141 7.418-7.141z"></path></svg>
...
<div class = "user_navigation_works_no_data" style = "display: none;">
    ...
    <div class = "user_navigation_works_no_data_title">
        ...
    </div>
    <div class = "user_navigation_works_no_data_description">
        ...
    </div>
</div>
<div class = "user_navigation_works_contents_loading" style = "padding: 20px; display: none;">
